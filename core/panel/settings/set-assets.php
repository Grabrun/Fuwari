...
$options[] = array(
	...
	$gravatar_array = array(
		...
		'qiniu' => __('七牛源', 'ui_fuwari_com'),
		'geekzu' => __('极客源', 'ui_fuwari_com'),
		'v2excom' => __('v2ex源', 'ui_fuwari_com'),
    ...
    $options[] = array(
        ...
        'desc' => __('（通过镜像服务器可对gravatar头像进行加速）', 'ui_fuwari_com'),
        'id' => 'fuwari_gravatar_url',       
        'std' => 'lolinet',
        'type' => 'select',
