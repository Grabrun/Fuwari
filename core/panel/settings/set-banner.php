...
$options[] = array(
    ...
    $options[] = array(
        ...
        $hitokoto_array = array(
			...
			'c' => __('游戏', 'ui_fuwari_com'),
			'd' => __('文学', 'ui_fuwari_com'),
			'e' => __('原创', 'ui_fuwari_com'),
			'f' => __('来自网络', 'ui_fuwari_com'),	
			'g' => __('其他', 'ui_fuwari_com'),
			'h' => __('影视', 'ui_fuwari_com'),
			'i' => __('诗词', 'ui_fuwari_com'),
    ...
    $options[] = array(
		...
		'desc' => __('（自动检索本地assets/images/banner/文件夹的jpg\jpeg\png\gif\webp图片）', 'ui_fuwari_com'),
